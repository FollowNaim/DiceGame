  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-center items-center mt-4">
        <div className="flex">
          <button
            className="bg-black text-white w-36 p-2 border-0 outline-0 rounded"
            onClick={() => setScore(0)}
          >
            Reset Score
          </button>
          <button
            className="bg-gray-500 text-white w-36 p-2 border-0 outline-0 ml-2 rounded"
            onClick={rulesToggle}
          >
        ...
        <button
          className="bg-orange-800 mt-4 text-white w-36 p-2 border-0 outline-0 ml-2 rounded"
          onClick={infoToggle}
        >
          {showInfo ? "Hide Info" : "Connect Noob"}
        </button>
      </div>
      {rules ? <Rules /> : null}
